...
export default function Contact() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center min-h-screen bg-[#0A192F] text-white font-geist-mono gap-10 py-10 sm:pt-96 md:pt-0" id="contact">
