...
export default function Hero() {
  ...
  return (
    <div className="bg-[#0A192F] w-full min-h-screen flex justify-center items-center font-geist-mono py-5">
      <div className="flex flex-col border w-[85%] min-h-[500px] rounded border-dashed p-10 space-y-5">
        ...
        <h2 className="text-white sm:text-3xl lg:text-5xl font-semibold tracking-wider">
          Muhamad Gatot.
        </h2>
        <h2 className="md:text-xl lg:text-2xl font-semibold flex items-center gap-5 text-[#59E3C6]">
          A Software Enginer focusing at <PiArrowBendRightDownBold size={40} />
        </h2>
        <h2 className="text-white sm:text-2xl md:text-5xl lg:text-7xl font-semibold pb-5">
          Web Scraping & Automation.
        </h2>
        <p className="w-[80%] text-white text-justify pb-10">
